...
integer, parameter :: kocean3 = 18
integer, parameter :: keclg1 = 19
integer, parameter :: kmant3 = 20
integer, parameter :: kmant4 = 21

integer, parameter, dimension(6) :: mantle_phases = (/kmant1, kmant2, kserp, khydmant, kmant3, kmant4/)
end module phases
